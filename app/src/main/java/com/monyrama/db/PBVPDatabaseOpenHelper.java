...
abstract class PBVPDatabaseOpenHelper extends SQLiteOpenHelper {	
	...
	protected final static String EXPENSES_SAVED_COMMENTS = "expenses_saved_comments";
	protected final static String INCOMES_SAVED_COMMENTS = "incomes_saved_comments";
	...
	protected final static String ACCOUNT_SUM = "account_sum";
	protected final static String ACCOUNT_NAME = "account_name";
	protected final static String ACCOUNT_COMMENT = "account_comment";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		final String CREATE_EXPENSES_SAVED_COMMENTS_TABLE = "CREATE TABLE [expenses_saved_comments] " +
				"([commentid] INTEGER  NOT NULL PRIMARY KEY AUTOINCREMENT, " +
				"[comment] TEXT NOT NULL UNIQUE, " +
				"[ts] DATETIME NOT NULL)";

		final String CREATE_INCOMES_SAVED_COMMENTS_TABLE = "CREATE TABLE [incomes_saved_comments] " +
				"([commentid] INTEGER  NOT NULL PRIMARY KEY AUTOINCREMENT, " +
				"[comment] TEXT NOT NULL UNIQUE, " +
				"[ts] DATETIME NOT NULL)";
	    ...
	    try {
			...
			db.execSQL(CREATE_EXPENSES_SAVED_COMMENTS_TABLE);
			db.execSQL(CREATE_INCOMES_SAVED_COMMENTS_TABLE);
	...
	protected String toCentsString(BigDecimal money) {
		return money.multiply(ONE_HUNDRED).toString();
	}

	protected BigDecimal toMoney(Integer cents) {
		return new BigDecimal(cents).divide(ONE_HUNDRED);
	}
}
